...
if(!isset($_POST['name']) ||
       ...
       !isset($_POST['brand_select']) ||

       !isset($_POST['price_select']) ||
...
$addres = $_POST['address']; // required

$phone = $_POST['phone']; // required

$brand_select = $_POST['brand_select']; // required

$price_select = $_POST['price_select']; // required

$datetime = $_POST['datetime']; // required
...
$email_message .= "SERVICE TYPE: ".clean_string($brand_select)."\n";

$email_message .= "PRICE: ".clean_string($price_select)."\n";

$email_message .= "DATE & TIME: ".clean_string($datetime )."\n";
